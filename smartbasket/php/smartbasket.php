...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
	...
	if ($_SERVER["REQUEST_METHOD"] == "GET") {
		if (isset($_GET['userName']) ) {
			if(empty($_GET['userName'])) {
				...
				$name = "<b>Имя: </b>" . strip_tags($_GET['userName']) . "; ";
			}
		}
		if (isset($_GET['userTel']) ) {
			if(empty($_GET['userTel'])) {
				echo 'notTel';
			} else {
				$tel = "<b>Телефон: </b>" . strip_tags($_GET['userTel']) . "<br>";
			}
		}
		...
		if (isset($_GET['userEmail']) ) {
			if(empty($_GET['userEmail'])) {
				...
				$email = "<b>Email: </b>" . strip_tags($_GET['userEmail']) . "<br>";
			}
		}
       ...
       /* if (isset($_POST['agreement']) ) {
        ...
        if (isset($_GET['finalPrice']) ) {
            $finalPrice = "<b>Общая стоимость: </b>" . strip_tags($_GET['finalPrice']) . "<br>";
        }
	...
	$mail->setFrom(SENDER);
    $mail->addBCC(CATCHER);
    $mail->addAddress($_GET['userEmail']); // отправка письма для клиента
